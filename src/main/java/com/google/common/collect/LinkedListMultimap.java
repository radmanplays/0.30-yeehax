 ...
 * {@code List}, instead of the {@code Collection} specified by the
...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
	 ...
	 *
	 * <p>
	 * If any entries for the specified {@code key} already exist in the multimap,
	 ...
	 * order they were added to the multimap. Because the values may have duplicates
	 * and follow the insertion ordering, this method returns a {@link List},
	 * instead of the {@link Collection} specified in the {@link ListMultimap}
	 * interface.
	 */
	@Override
	 ...
	 *             values, followed by successive keys and values from the entries()
	 *             ordering
	 */
