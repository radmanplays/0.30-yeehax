...
public final class Longs {
	 ...
	 * different types), use a shared {@link net.lax1dude.eaglercraft.internal.buffer.ByteBuffer} instance, or use
	 ...
	 *
	 * <p>
	 * Arguably, it's preferable to use {@link net.lax1dude.eaglercraft.internal.buffer.ByteBuffer}; that library
