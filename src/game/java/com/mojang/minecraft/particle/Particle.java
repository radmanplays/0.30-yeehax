...
public class Particle extends Entity {
	...
	public void render(WorldRenderer var1, float var2, float var3, float var4, float var5, float var6, float var7) {
		...
		var1.pos(var13 - var3 * var12 - var6 * var12, var14 - var4 * var12, var15 - var5 * var12 - var7 * var12)
				.tex(var8, var11).color(this.rCol * var2, this.gCol * var2, this.bCol * var2, 1.0f).endVertex();
		var1.pos(var13 - var3 * var12 + var6 * var12, var14 + var4 * var12, var15 - var5 * var12 + var7 * var12)
				.tex(var8, var10).color(this.rCol * var2, this.gCol * var2, this.bCol * var2, 1.0f).endVertex();
		var1.pos(var13 + var3 * var12 + var6 * var12, var14 + var4 * var12, var15 + var5 * var12 + var7 * var12)
				.tex(var9, var10).color(this.rCol * var2, this.gCol * var2, this.bCol * var2, 1.0f).endVertex();
		var1.pos(var13 + var3 * var12 - var6 * var12, var14 - var4 * var12, var15 + var5 * var12 - var7 * var12)
				.tex(var9, var11).color(this.rCol * var2, this.gCol * var2, this.bCol * var2, 1.0f).endVertex();
	}
