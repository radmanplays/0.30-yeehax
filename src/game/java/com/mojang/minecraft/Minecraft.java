                        ...
                        if(this.level != null) {
                           ...
                           for(var81 = 0; var81 < var37.size(); ++var81) {
                              ...
                              if((var88 = (Entity)var37.get(var81)).isPickable()) {
                                 ...
                                 if((var78 = var88.bb.grow(var74, var74, var74).clip(playerVector, var71)) != null && ((var74 = playerVector.distance(var78.vec)) < var35 || var35 == 0.0F)) {
                           ...
                           while(true) {
                              ...
                              Block var73;
                              if((var73 = Block.blocks[this.level.getTile((int)this.player.x, (int)(this.player.y + 0.12F), (int)this.player.z)]) != null && var73.getLiquidType() != LiquidType.NOT_LIQUID) {
                                 LiquidType var79;
                              ...
                              GL11.glRotatef(this.player.xRotO + (this.player.xRot - this.player.xRotO) * this.timer.delta, 1.0F, 0.0F, 0.0F);
                              GL11.glRotatef(this.player.yRotO + (this.player.yRot - this.player.yRotO) * this.timer.delta, 0.0F, 1.0F, 0.0F);
                              ...
                              for(var83 = 0; var83 < 2; ++var83) {
                                 if(this.particleManager.particles.get(var83).size() != 0) {
                                    ...
                                    for(var120 = 0; var120 < this.particleManager.particles.get(var83).size(); ++var120) {
                                       ((Particle)this.particleManager.particles.get(var83).get(var120)).render(var121, this.timer.delta, var29, var69, var30, var117, var32);
                                    }
                              ...
                              if(this.selected != null) {
                                 ...
                                 if(this.levelRenderer.cracks > 0.0F) {
                                    ...
                                    GL11.glPushMatrix();
                                    var73 = (var114 = this.levelRenderer.level.getTile(this.selected.x, this.selected.y, this.selected.z)) > 0?Block.blocks[var114]:Block.STONE;
                                    var74 = (var73.x1 + var73.x2) / 2.0F;
                                    var33 = (var73.y1 + var73.y2) / 2.0F;
                                    var34 = (var73.z1 + var73.z2) / 2.0F;
                                    GL11.glTranslatef((float)this.selected.x + var74, (float)this.selected.y + var33, (float)this.selected.z + var34);
                                    var35 = 1.01F;
                                    ...
                                    for(var86 = 0; var86 < 6; ++var86) {
                                       var73.renderSide(var113, this.selected.x, this.selected.y, this.selected.z, var86, 240 + (int)(this.levelRenderer.cracks * 10.0F));
                                    }
                                 ...
                                 GL11.glDepthMask(false);
                                 var29 = 0.002F;
                                 if((var104 = this.levelRenderer.level.getTile(this.selected.x, this.selected.y, this.selected.z)) > 0) {
									 AABB var111 = Block.blocks[var104].getSelectionBox(this.selected.x, this.selected.y, this.selected.z).grow(var29, var29, var29);
                              ...
                              if(this.raining) {
                                 ...
                                 for(var110 = var104 - 5; var110 <= var104 + 5; ++var110) {
                                    for(var122 = var114 - 5; var122 <= var114 + 5; ++var122) {
                                       ...
                                       if(var86 != var125) {
                                          var74 = ((float)((this.renderer.levelTicks + var110 * 3121 + var122 * 418711) % 32) + this.timer.delta) / 32.0F;
                              ...
                              var117 = this.renderer.heldBlock.lastPos + (this.renderer.heldBlock.pos - this.renderer.heldBlock.lastPos) * this.timer.delta;
                              GL11.glPushMatrix();
                              GL11.glRotatef(this.player.xRotO + (this.player.xRot - this.player.xRotO) * this.timer.delta, 1.0F, 0.0F, 0.0F);
                              GL11.glRotatef(this.player.yRotO + (this.player.yRot - this.player.yRotO) * this.timer.delta, 0.0F, 1.0F, 0.0F);
                              this.renderer.setLighting(true);
                              ...
                              if(this.renderer.heldBlock.moving) {
                                 var33 = MathHelper.sin((var74 = ((float)this.renderer.heldBlock.offset + this.timer.delta) / 7.0F) * 3.1415927F);
                              ...
                              GL11.glEnable(2977);
                              if(this.renderer.heldBlock.moving) {
                                 var33 = MathHelper.sin((var74 = ((float)this.renderer.heldBlock.offset + this.timer.delta) / 7.0F) * var74 * 3.1415927F);
                              ...
                              GL11.glColor4f(var74 = this.level.getBrightness((int)this.player.x, (int)this.player.y, (int)this.player.z), var74, var74, 1.0F);
         ...
         if(this.raining) {
            ...
            for(var8 = 0; var8 < 50; ++var8) {
               ...
               if((var57 = this.level.getHighestTile(var60, var52)) <= var46 + 4 && var57 >= var46 - 4) {
                  ...
                  this.particleManager.spawnParticle(new WaterDropParticle(this.level, (float)var60 + var56, (float)var57 + 0.1F, (float)var52 + var62));
               }
            }
         }
