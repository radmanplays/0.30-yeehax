	...
	public final void animate() {
		...
		for (var1 = 0; var1 < 16; ++var1) {
			for (var2 = 0; var2 < 16; ++var2) {
				...
				this.green[var1 + (var2 << 4)] = var3 / 10.0F
						+ (this.blue[(var1 & 15) + ((var2 & 15) << 4)] + this.blue[(var1 + 1 & 15) + ((var2 & 15) << 4)]
								+ this.blue[(var1 + 1 & 15) + ((var2 + 1 & 15) << 4)]
								+ this.blue[(var1 & 15) + ((var2 + 1 & 15) << 4)]) / 4.0F * 0.8F;
