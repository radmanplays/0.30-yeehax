...
public final class MobSpawner {
	...
	public final int spawn(int var1, Entity var2, ProgressBarDisplay var3) {
		...
		for (int var5 = 0; var5 < var1; ++var5) {
			...
			int var8 = (int) (Math.min(this.level.random.nextFloat(), this.level.random.nextFloat())
					* (float) this.level.depth);
			int var9 = this.level.random.nextInt(this.level.height);
			if (!this.level.isSolidTile(var7, var8, var9)
					&& this.level.getLiquid(var7, var8, var9) == LiquidType.NOT_LIQUID
