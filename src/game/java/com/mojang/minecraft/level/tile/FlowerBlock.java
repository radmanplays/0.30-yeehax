...
public class FlowerBlock extends Block {
   ...
   private void renderWithColors(WorldRenderer var1, float var2, float var3, float var4, float r, float g, float b, float a) {
	      int var15;
	      int var5 = (var15 = this.getTextureId(15)) % 16 << 4;
	      int var6 = var15 / 16 << 4;
	      float var16 = (float)var5 / 256.0F;
   ...
   private void renderWithNormals(WorldRenderer var1, float var2, float var3, float var4, float normalx, float normaly, float normalz) {
	      int var15;
	      int var5 = (var15 = this.getTextureId(15)) % 16 << 4;
	      int var6 = var15 / 16 << 4;
	      float var16 = (float)var5 / 256.0F;
