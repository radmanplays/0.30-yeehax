...
public class Level implements Serializable {
		...
		for (; var3 < var4; ++var3) {
			for (int var9 = var5; var9 < var6; ++var9) {
				for (int var10 = var7; var10 < var8; ++var10) {
					AABB var11;
					if (var3 >= 0 && var9 >= 0 && var10 >= 0 && var3 < this.width && var9 < this.depth
							&& var10 < this.height) {
						Block var12;
						if ((var12 = Block.blocks[this.getTile(var3, var9, var10)]) != null
		...
		if (this.tickCount % 5 == 0) {
			...
			for (var7 = 0; var7 < var6; ++var7) {
				...
				if ((var8 = (NextTickListEntry) this.tickList.remove(0)).ticks > 0) {
					...
					byte var9;
					if (this.isInBounds(var8.x, var8.y, var8.z)
							&& (var9 = this.blocks[(var8.y * this.height + var8.z) * this.width + var8.x]) == var8.block
							&& var9 > 0) {
	...
	public void explode(Entity var1, float var2, float var3, float var4, float var5) {
		...
		List<Entity> var18 = this.blockMap.getEntities(var1, (float) var6, (float) var8, (float) var10, (float) var7,
