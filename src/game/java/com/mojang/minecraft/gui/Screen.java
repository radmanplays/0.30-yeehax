...
public class Screen {
	...
	public final void drawImage(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		var9.pos((float) var1, (float) (var2 + var6), this.imgZ).tex((float) var3 * var7, (float) (var4 + var6) * var8)
				.endVertex();
		var9.pos((float) (var1 + var5), (float) (var2 + var6), this.imgZ)
				.tex((float) (var3 + var5) * var7, (float) (var4 + var6) * var8).endVertex();
		var9.pos((float) (var1 + var5), (float) var2, this.imgZ).tex((float) (var3 + var5) * var7, (float) var4 * var8)
				.endVertex();
