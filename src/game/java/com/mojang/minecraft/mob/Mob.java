...
public class Mob extends Entity {
	...
	public void render(TextureManager var1, float var2) {
		if (this.modelName != null) {
			...
			GL11.glTranslatef(this.xo + (this.x - this.xo) * var2,
					this.yo + (this.y - this.yo) * var2 - 1.62F + this.renderOffset,
			...
			if ((var11 = (float) this.hurtTime - var2) > 0.0F || this.health <= 0) {
				if (var11 < 0.0F) {
					...
					var11 = MathHelper.sin((var11 /= (float) this.hurtDuration) * var11 * var11 * var11 * 3.1415927F)
							* 14.0F;
				}
	...
	public void renderModel(TextureManager var1, float var2, float var3, float var4, float var5, float var6,
			float var7) {
